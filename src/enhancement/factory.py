from src.enhancement.classical.cnn.enhancer import CNNEnhancer
...
def build_enhancer(model_name,noise_type="white",**kwargs):
    ...
    if model_name=="cnn":
        kwargs.setdefault("noise_type",noise_type,)
